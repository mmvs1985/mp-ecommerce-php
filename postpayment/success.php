...
<html class="supports-animation supports-columns svg no-touch no-ie no-oldie no-ios supports-backdrop-filter as-mouseuser" lang="en-US"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <title>Tienda e-commerce| compra exitosa</title>
                        ...
                        <div class="pd-billboard pd-category-header">
                            <div class="pd-l-plate-scale">
                                ...
                                <div class="pd-billboard-info">
                                    <h1 class="pd-billboard-header pd-util-compact-small-18">Pago exitoso</h1>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="width:60%">
                                ...
                                <div class="as-producttile-info" id="btn"style="float:left;min-height: 168px;">
                                    <div class="as-producttile-titlepricewraper" style="min-height: 128px;">
                                        ...
                                        <h3 >
                                            <?php echo "payment method: " . $_GET['payment_type']?>
                                        ...
                                        <h3 >
                                            <?php echo "payment_id: " . $_GET['collection_id']?>
                                    ...
                                    <form action="https://mmvs1985-mp-ecommerce-php.herokuapp.com" method="get">
                                        <button type="submit" class="mercadopago-button">volver</button>
                                    </form> 
